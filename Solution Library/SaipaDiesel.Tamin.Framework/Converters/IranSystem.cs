...
namespace SaipaDiesel.Tamin.Framework.Converters;

public static class IranSystem
{
    ...
    new Dictionary<byte, byte>
{
    ...
    /// <param name="iranSystemEncodedString">رشته ایران سیستم</param>
    /// <returns></returns>
    public static string IranSystemToUnicode(this string text, TextEncoding textEncoding = TextEncoding.Windows1256)
    {
        ...
        // تبدیل رشته به بایت
        byte[] stringBytes = encoding.GetBytes(text.Trim());
    ...
    public static string UnicodeToIranSystem(this string text, IranSystemNumbers iranSystemNumbers = IranSystemNumbers.DontConvert)
    {
        EncodingProvider ppp = CodePagesEncodingProvider.Instance;
        Encoding.RegisterProvider(ppp);
